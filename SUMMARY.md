...
- [OWASP Kubernetes Top Ten ja](README.md)
...
- OWASP Kubernetes Top 10 2025
  ...
  - [K05:2025 ネットワークセグメンテーションコントロールの欠落](Document/2025/ja/src/K05-Missing-Network-Segmentation-Controls.md)
  - [K06:2025 過度に開示された Kubernetes コンポーネント](Document/2025/ja/src/K06-Overly-Exposed-Kubernetes-Components.md)
  - [K07:2025 誤構成された脆弱なクラスタコンポーネント](Document/2025/ja/src/K07-Misconfigured-And-Vulnerable-Cluster-Components.md)
  - [K08:2025 クラスタからクラウドへのラテラルムーブメント](Document/2025/ja/src/K08-Cluster-To-Cloud-Lateral-Movement.md)
  - [K09:2025 不備のある認証メカニズム](Document/2025/ja/src/K09-Broken-Authentication-Mechanisms.md)
  - [K10:2025 不十分なログ記録と監視](Document/2025/ja/src/K10-Inadequate-Logging-And-Monitoring.md)
